...
assert.match(wxml, /让想法，/);
assert.match(wxss, /--bg: #f2e8d7/);
assert.match(wxss, /background-image: url\("data:image\/svg\+xml;base64,/);
...
assert.equal(app.tabBar.backgroundColor, '#f5eddc');
